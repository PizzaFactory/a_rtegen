...
perl $OS_PATH/configure -T $TARGET -A Rte $CFG_OPT \
	...
	-C "$APPLICATION $GENERAL_PATH/HelloAutosar/SystemDesk Rte_GeneratedEcuc" \
...
../../../bin/bin/rtegen.sh $OS_PATH/target/$TARGET/target_hw_counter.arxml $GENERAL_PATH/HelloAutosar/SystemDesk.arxml $APPLICATION.arxml Rte_GeneratedEcuc.arxml
