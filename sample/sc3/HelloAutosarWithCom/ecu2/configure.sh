...
../../../../bin/bin/rtegen $OS_PATH/target/$TARGET/target_hw_counter.arxml $GENERAL_PATH/HelloAutosar/SystemDesk_WithCom_EcuInstance2.arxml $APPLICATION.arxml Rte_GeneratedEcuc.arxml
