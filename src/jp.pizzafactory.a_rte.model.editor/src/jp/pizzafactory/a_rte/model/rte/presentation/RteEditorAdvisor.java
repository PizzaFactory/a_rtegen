/**
 */
package jp.pizzafactory.a_rte.model.rte.presentation;
...
import jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.ecuc.presentation.EcucEditor;

import jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.instance.presentation.InstanceEditor;

import jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.m2.presentation.M2Editor;

import jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.presentation.Ar4xEditor;

import jp.ac.nagoya_u.is.nces.a_rte.model.rte.ex.presentation.ExEditor;

import jp.ac.nagoya_u.is.nces.a_rte.model.rte.interaction.presentation.InteractionEditor;

import jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.presentation.ModuleEditor;

import jp.ac.nagoya_u.is.nces.a_rte.model.rte.presentation.RteEditor;
 ...
 * @generated
 */
public final class RteEditorAdvisor extends WorkbenchAdvisor {
	/**
	...
	private static String[] getFileExtensionFilters() {
		...
		result.addAll(RteEditor.FILE_EXTENSION_FILTERS);
		result.addAll(ExEditor.FILE_EXTENSION_FILTERS);
		result.addAll(InteractionEditor.FILE_EXTENSION_FILTERS);
		result.addAll(ModuleEditor.FILE_EXTENSION_FILTERS);
		result.addAll(Ar4xEditor.FILE_EXTENSION_FILTERS);
		result.addAll(M2Editor.FILE_EXTENSION_FILTERS);
		result.addAll(EcucEditor.FILE_EXTENSION_FILTERS);
		result.addAll(InstanceEditor.FILE_EXTENSION_FILTERS);
	...
	private static String getString(String key, Object s1) {
		return jp.pizzafactory.a_rte.model.rte.presentation.RteEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
	...
	public static class Application implements IApplication {
		...
		public Object start(IApplicationContext context) throws Exception {
			WorkbenchAdvisor workbenchAdvisor = new RteEditorAdvisor();
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "jp.pizzafactory.a_rte.model.rte.presentation.RteEditorAdvisorPerspective"; //$NON-NLS-1$
	...
	/**
	 * Open action for the objects from the Rte model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Open URI action for the objects from the Rte model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
