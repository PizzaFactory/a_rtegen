...
public class EcucActionBarContributor
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("ecuc-settings"));
		toolBarManager.add(new Separator("ecuc-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(RteEditorPlugin.INSTANCE.getString("_UI_EcucEditor_menu"), "jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.ecucMenuID");
