...
public class Ar4xActionBarContributor
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("ar4x-settings"));
		toolBarManager.add(new Separator("ar4x-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(RteEditorPlugin.INSTANCE.getString("_UI_Ar4xEditor_menu"), "jp.ac.nagoya_u.is.nces.a_rte.model.ar4xMenuID");
