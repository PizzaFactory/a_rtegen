...
public class EcucModelWizard extends Wizard implements INewWizard {
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setDefaultPageImageDescriptor(ExtendedImageRegistry.INSTANCE.getImageDescriptor(RteEditorPlugin.INSTANCE.getImage("full/wizban/NewEcuc"))); //$NON-NLS-1$
	}
			...
			resourceURIBrowseFileSystemButton.addSelectionListener
				(new SelectionAdapter() {
					 ...
					 public void widgetSelected(SelectionEvent event) {
						 String[] filters = EcucEditor.FILE_EXTENSION_FILTERS.toArray(new String[EcucEditor.FILE_EXTENSION_FILTERS.size()]);
	...
	public void addPages() {
		initialObjectCreationPage = new EcucModelWizardInitialObjectCreationPage("Whatever2"); //$NON-NLS-1$
		initialObjectCreationPage.setTitle(RteEditorPlugin.INSTANCE.getString("_UI_EcucModelWizard_label")); //$NON-NLS-1$
