...
public class RteActionBarContributor
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("rte-settings"));
		toolBarManager.add(new Separator("rte-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(RteEditorPlugin.INSTANCE.getString("_UI_RteEditor_menu"), "jp.ac.nagoya_u.is.nces.a_rte.model.rteMenuID");
