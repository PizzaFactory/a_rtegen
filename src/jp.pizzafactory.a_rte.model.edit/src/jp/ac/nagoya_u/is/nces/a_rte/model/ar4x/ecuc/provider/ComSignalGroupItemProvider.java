...
public class ComSignalGroupItemProvider extends EcucContainerItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComSignalGroup_comSystemTemplateSignalGroup_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComSignalGroup_comSystemTemplateSignalGroup_feature", "_UI_ComSignalGroup_type"),
	...
	protected void addComHandleIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComSignalGroup_comHandleId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComSignalGroup_comHandleId_feature", "_UI_ComSignalGroup_type"),
	...
	protected void addComTransferPropertyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComSignalGroup_comTransferProperty_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComSignalGroup_comTransferProperty_feature", "_UI_ComSignalGroup_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ComSignalGroup"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ComSignalGroup_type") :
			getString("_UI_ComSignalGroup_type") + " " + label;
	}
