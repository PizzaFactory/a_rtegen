...
public class RteBufferInvalidateTrustedFunctionItemProvider extends TrustedFunctionItemProvider {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RteBufferInvalidateTrustedFunction"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_RteBufferInvalidateTrustedFunction_type") :
			getString("_UI_RteBufferInvalidateTrustedFunction_type") + " " + label;
	}
