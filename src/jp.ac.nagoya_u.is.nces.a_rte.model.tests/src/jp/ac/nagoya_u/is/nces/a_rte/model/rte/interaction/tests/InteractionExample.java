...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>interaction</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class InteractionExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.interaction")); //$NON-NLS-1$
				InteractionObject root = InteractionFactory.eINSTANCE.createInteractionObject();
