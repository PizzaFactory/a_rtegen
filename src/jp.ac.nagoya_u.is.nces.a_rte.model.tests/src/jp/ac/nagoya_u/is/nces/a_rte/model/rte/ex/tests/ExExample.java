...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>ex</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ExExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.ex")); //$NON-NLS-1$
				TimeValueEx root = ExFactory.eINSTANCE.createTimeValueEx();
