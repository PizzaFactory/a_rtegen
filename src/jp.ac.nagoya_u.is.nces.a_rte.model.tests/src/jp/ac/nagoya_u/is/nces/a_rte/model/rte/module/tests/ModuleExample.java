...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>module</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(ModulePackage.eNS_URI, 
			 ModulePackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.module")); //$NON-NLS-1$
				BswSchedulableEntity root = ModuleFactory.eINSTANCE.createBswSchedulableEntity();
