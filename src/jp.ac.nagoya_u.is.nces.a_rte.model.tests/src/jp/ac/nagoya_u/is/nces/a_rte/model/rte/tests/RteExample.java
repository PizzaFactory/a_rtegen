...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>rte</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class RteExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.rte")); //$NON-NLS-1$
				RteRoot root = RteFactory.eINSTANCE.createRteRoot();
