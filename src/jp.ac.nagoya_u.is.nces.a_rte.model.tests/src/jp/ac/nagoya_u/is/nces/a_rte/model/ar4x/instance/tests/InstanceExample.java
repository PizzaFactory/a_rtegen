...
public class InstanceExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.instance")); //$NON-NLS-1$
				PortInstanceInComposition root = InstanceFactory.eINSTANCE.createPortInstanceInComposition();
