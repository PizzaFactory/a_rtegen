...
/**
 * This is the action bar contributor for the Ex model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExActionBarContributor
	extends EditingDomainActionBarContributor
	implements ISelectionChangedListener {
	/**
	 * Action to create objects from the Ex model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			ExModelWizard wizard = new ExModelWizard();
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("ex-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("ex-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(RteEditorPlugin.INSTANCE.getString("_UI_ExEditor_menu"), "jp.ac.nagoya_u.is.nces.a_rte.model.rte.exMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
