 ...
 * @generated
 */
public class M2ModelWizard extends Wizard implements INewWizard {
	/**
	...
	public static final List<String> FILE_EXTENSIONS =
		Collections.unmodifiableList(Arrays.asList(RteEditorPlugin.INSTANCE.getString("_UI_M2EditorFilenameExtensions").split("\\s*,\\s*"))); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public static final String FORMATTED_FILE_EXTENSIONS =
		RteEditorPlugin.INSTANCE.getString("_UI_M2EditorFilenameExtensions").replaceAll("\\s*,\\s*", ", "); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	 ...
	 * @generated
	 */
	protected M2Package m2Package = M2Package.eINSTANCE;
	 ...
	 * @generated
	 */
	protected M2ModelWizardInitialObjectCreationPage initialObjectCreationPage;
	...
	protected Collection<String> getInitialObjectNames() {
		if (initialObjectNames == null) {
			...
			for (EStructuralFeature eStructuralFeature : ExtendedMetaData.INSTANCE.getAllElements(ExtendedMetaData.INSTANCE.getDocumentRoot(m2Package))) {
	...
	public class M2ModelWizardInitialObjectCreationPage extends WizardPage {
		 ...
		 * @generated
		 */
		public M2ModelWizardInitialObjectCreationPage(String pageId) {
			super(pageId);
		}
