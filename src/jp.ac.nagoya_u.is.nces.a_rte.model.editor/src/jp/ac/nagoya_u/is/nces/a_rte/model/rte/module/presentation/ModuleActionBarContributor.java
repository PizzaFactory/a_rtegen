 ...
 * @generated
 */
public class ModuleActionBarContributor
	extends EditingDomainActionBarContributor
	implements ISelectionChangedListener {
	/**
	 * Action to create objects from the Module model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			ModuleModelWizard wizard = new ModuleModelWizard();
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("module-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("module-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(RteEditorPlugin.INSTANCE.getString("_UI_ModuleEditor_menu"), "jp.ac.nagoya_u.is.nces.a_rte.model.rte.moduleMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
