...
/**
 * This is the action bar contributor for the Ecuc model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EcucActionBarContributor
	extends EditingDomainActionBarContributor
	implements ISelectionChangedListener {
	/**
	 * Action to create objects from the Ecuc model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			EcucModelWizard wizard = new EcucModelWizard();
	 ...
	 * @generated
	 */
	public EcucActionBarContributor() {
		super(ADDITIONS_LAST_STYLE);
		loadResourceAction = new LoadResourceAction();
		validateAction = new ValidateAction();
		liveValidationAction = new DiagnosticDecorator.LiveValidator.LiveValidationAction(RteEditorPlugin.getPlugin().getDialogSettings());
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("ecuc-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("ecuc-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(RteEditorPlugin.INSTANCE.getString("_UI_EcucEditor_menu"), "jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.ecucMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
