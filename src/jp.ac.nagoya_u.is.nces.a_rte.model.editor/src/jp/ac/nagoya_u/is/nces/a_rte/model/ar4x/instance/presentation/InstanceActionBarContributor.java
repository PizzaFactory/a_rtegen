...
public class InstanceActionBarContributor
	...
	/**
	 * Action to create objects from the Instance model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			InstanceModelWizard wizard = new InstanceModelWizard();
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(RteEditorPlugin.INSTANCE.getString("_UI_InstanceEditor_menu"), "jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.instanceMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
