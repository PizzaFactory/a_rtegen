...
public class Ar4xModelWizard extends Wizard implements INewWizard {
	...
	public static final List<String> FILE_EXTENSIONS =
		Collections.unmodifiableList(Arrays.asList(RteEditorPlugin.INSTANCE.getString("_UI_Ar4xEditorFilenameExtensions").split("\\s*,\\s*"))); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public static final String FORMATTED_FILE_EXTENSIONS =
		RteEditorPlugin.INSTANCE.getString("_UI_Ar4xEditorFilenameExtensions").replaceAll("\\s*,\\s*", ", "); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setDefaultPageImageDescriptor(ExtendedImageRegistry.INSTANCE.getImageDescriptor(RteEditorPlugin.INSTANCE.getImage("full/wizban/NewAr4x"))); //$NON-NLS-1$
	}
			...
			resourceURIBrowseFileSystemButton.addSelectionListener
				(new SelectionAdapter() {
					 ...
					 public void widgetSelected(SelectionEvent event) {
						 String[] filters = Ar4xEditor.FILE_EXTENSION_FILTERS.toArray(new String[Ar4xEditor.FILE_EXTENSION_FILTERS.size()]);
	...
	public void addPages() {
		initialObjectCreationPage = new Ar4xModelWizardInitialObjectCreationPage("Whatever2"); //$NON-NLS-1$
		initialObjectCreationPage.setTitle(RteEditorPlugin.INSTANCE.getString("_UI_Ar4xModelWizard_label")); //$NON-NLS-1$
