...
public class RteModelWizard extends Wizard implements INewWizard {
	...
	public static final List<String> FILE_EXTENSIONS =
		Collections.unmodifiableList(Arrays.asList(RteEditorPlugin.INSTANCE.getString("_UI_RteEditorFilenameExtensions").split("\\s*,\\s*"))); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public static final String FORMATTED_FILE_EXTENSIONS =
		RteEditorPlugin.INSTANCE.getString("_UI_RteEditorFilenameExtensions").replaceAll("\\s*,\\s*", ", "); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setDefaultPageImageDescriptor(ExtendedImageRegistry.INSTANCE.getImageDescriptor(RteEditorPlugin.INSTANCE.getImage("full/wizban/NewRte"))); //$NON-NLS-1$
	}
			...
			resourceURIBrowseFileSystemButton.addSelectionListener
				(new SelectionAdapter() {
					 ...
					 public void widgetSelected(SelectionEvent event) {
						 String[] filters = RteEditor.FILE_EXTENSION_FILTERS.toArray(new String[RteEditor.FILE_EXTENSION_FILTERS.size()]);
	...
	public void addPages() {
		initialObjectCreationPage = new RteModelWizardInitialObjectCreationPage("Whatever2"); //$NON-NLS-1$
		initialObjectCreationPage.setTitle(RteEditorPlugin.INSTANCE.getString("_UI_RteModelWizard_label")); //$NON-NLS-1$
