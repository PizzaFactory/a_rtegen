...
/**
 * This is the action bar contributor for the Ar4x model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Ar4xActionBarContributor
	extends EditingDomainActionBarContributor
	implements ISelectionChangedListener {
	/**
	 * Action to create objects from the Ar4x model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			Ar4xModelWizard wizard = new Ar4xModelWizard();
	 ...
	 * @generated
	 */
	public Ar4xActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("ar4x-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("ar4x-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(RteEditorPlugin.INSTANCE.getString("_UI_Ar4xEditor_menu"), "jp.ac.nagoya_u.is.nces.a_rte.model.ar4xMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
