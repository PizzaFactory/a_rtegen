...
/**
 * This is the action bar contributor for the M2 model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class M2ActionBarContributor
	extends EditingDomainActionBarContributor
	implements ISelectionChangedListener {
	/**
	 * Action to create objects from the M2 model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			M2ModelWizard wizard = new M2ModelWizard();
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("m2-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("m2-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(RteEditorPlugin.INSTANCE.getString("_UI_M2Editor_menu"), "jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.m2MenuID"); //$NON-NLS-1$ //$NON-NLS-2$
