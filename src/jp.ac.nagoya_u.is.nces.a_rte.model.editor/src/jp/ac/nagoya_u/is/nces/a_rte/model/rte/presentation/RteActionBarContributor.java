...
/**
 * This is the action bar contributor for the Rte model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RteActionBarContributor
	extends EditingDomainActionBarContributor
	implements ISelectionChangedListener {
	/**
	 * Action to create objects from the Rte model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class NewAction extends WorkbenchWindowActionDelegate {
		...
		public void run(IAction action) {
			RteModelWizard wizard = new RteModelWizard();
	 ...
	 * @generated
	 */
	public RteActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("rte-settings")); //$NON-NLS-1$
		toolBarManager.add(new Separator("rte-additions")); //$NON-NLS-1$
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(RteEditorPlugin.INSTANCE.getString("_UI_RteEditor_menu"), "jp.ac.nagoya_u.is.nces.a_rte.model.rteMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
