 ...
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ComplexComSendProxyOperationImpl#getAccessApi <em>Access Api</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ComplexComSendProxyOperationImpl#getFunctionTableSymbolName <em>Function Table Symbol Name</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ComplexComSendProxyOperationImpl#getTableIndexVariable <em>Table Index Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ComplexComSendProxyOperationImpl extends OperationImpl implements ComplexComSendProxyOperation {
	/**
	 ...
	 * @generated
	 */
	protected ComplexComSendProxyOperationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModulePackage.Literals.COMPLEX_COM_SEND_PROXY_OPERATION;
	}
		...
		if (accessApi != null && ((EObject)accessApi).eIsProxy()) {
			...
			if (accessApi != oldAccessApi) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModulePackage.COMPLEX_COM_SEND_PROXY_OPERATION__ACCESS_API, oldAccessApi, accessApi));
			}
		}
		return accessApi;
	}
	...
	public void setAccessApi(IocReceiveApi newAccessApi) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.COMPLEX_COM_SEND_PROXY_OPERATION__ACCESS_API, oldAccessApi, accessApi));
	}
	...
	public void setFunctionTableSymbolName(String newFunctionTableSymbolName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.COMPLEX_COM_SEND_PROXY_OPERATION__FUNCTION_TABLE_SYMBOL_NAME, oldFunctionTableSymbolName, functionTableSymbolName));
	}
	...
	public Variable getTableIndexVariable() {
		if (tableIndexVariable != null && ((EObject)tableIndexVariable).eIsProxy()) {
			...
			if (tableIndexVariable != oldTableIndexVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModulePackage.COMPLEX_COM_SEND_PROXY_OPERATION__TABLE_INDEX_VARIABLE, oldTableIndexVariable, tableIndexVariable));
			}
		}
	...
	public void setTableIndexVariable(Variable newTableIndexVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.COMPLEX_COM_SEND_PROXY_OPERATION__TABLE_INDEX_VARIABLE, oldTableIndexVariable, tableIndexVariable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModulePackage.COMPLEX_COM_SEND_PROXY_OPERATION__ACCESS_API:
			...
			case ModulePackage.COMPLEX_COM_SEND_PROXY_OPERATION__TABLE_INDEX_VARIABLE:
...
} //ComplexComSendProxyOperationImpl
