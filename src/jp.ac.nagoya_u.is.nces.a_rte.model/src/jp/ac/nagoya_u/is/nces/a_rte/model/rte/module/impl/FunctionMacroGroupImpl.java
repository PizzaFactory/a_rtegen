...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Function Macro Group</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.FunctionMacroGroupImpl#getFunctionMacro <em>Function Macro</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.FunctionMacroGroupImpl#getMemoryMapping <em>Memory Mapping</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FunctionMacroGroupImpl extends ModuleObjectImpl implements FunctionMacroGroup {
	/**
	 ...
	 * @generated
	 */
	protected FunctionMacroGroupImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModulePackage.Literals.FUNCTION_MACRO_GROUP;
	}
	...
	public EList<FunctionMacro> getFunctionMacro() {
		if (functionMacro == null) {
			functionMacro = new EObjectContainmentEList<FunctionMacro>(FunctionMacro.class, this, ModulePackage.FUNCTION_MACRO_GROUP__FUNCTION_MACRO);
		}
		...
		if (memoryMapping != null && ((EObject)memoryMapping).eIsProxy()) {
			...
			if (memoryMapping != oldMemoryMapping) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModulePackage.FUNCTION_MACRO_GROUP__MEMORY_MAPPING, oldMemoryMapping, memoryMapping));
			}
		}
	...
	public void setMemoryMapping(MemoryMapping newMemoryMapping) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.FUNCTION_MACRO_GROUP__MEMORY_MAPPING, oldMemoryMapping, memoryMapping));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModulePackage.FUNCTION_MACRO_GROUP__FUNCTION_MACRO:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModulePackage.FUNCTION_MACRO_GROUP__MEMORY_MAPPING:
