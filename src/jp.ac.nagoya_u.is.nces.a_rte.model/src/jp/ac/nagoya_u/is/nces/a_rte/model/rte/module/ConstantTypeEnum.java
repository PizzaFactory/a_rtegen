 ...
 * <!-- end-user-doc -->
 * @see jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.ModulePackage#getConstantTypeEnum()
 * @model
 * @generated
 */
public enum ConstantTypeEnum implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Constant Type Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ConstantTypeEnum[] VALUES_ARRAY =
		new ConstantTypeEnum[] {
			NUMERICAL_VALUE,
			TEXT_VALUE,
			UNKNOWN_VALUE,
		};
	...
	/**
	 * A public read-only list of all the '<em><b>Constant Type Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ConstantTypeEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Constant Type Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ConstantTypeEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ConstantTypeEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Constant Type Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ConstantTypeEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ConstantTypeEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Constant Type Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ConstantTypeEnum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ConstantTypeEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
