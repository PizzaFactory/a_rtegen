 ...
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.PartitionTerminatedApiImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PartitionTerminatedApiImpl extends RteLifecycleApiImpl implements PartitionTerminatedApi {
	...
	public NotificationChain basicSetOperation(InterPartitionTimeoutOperation newOperation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModulePackage.PARTITION_TERMINATED_API__OPERATION, oldOperation, newOperation);
	...
	public void setOperation(InterPartitionTimeoutOperation newOperation) {
		if (newOperation != operation) {
			...
			if (operation != null)
				msgs = ((InternalEObject)operation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModulePackage.PARTITION_TERMINATED_API__OPERATION, null, msgs);
			if (newOperation != null)
				msgs = ((InternalEObject)newOperation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModulePackage.PARTITION_TERMINATED_API__OPERATION, null, msgs);
			msgs = basicSetOperation(newOperation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.PARTITION_TERMINATED_API__OPERATION, newOperation, newOperation));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModulePackage.PARTITION_TERMINATED_API__OPERATION:
