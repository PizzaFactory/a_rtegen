...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Com Invalidate Callback</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ComInvalidateCallbackImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ComInvalidateCallbackImpl#getFilterResultVariable <em>Filter Result Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ComInvalidateCallbackImpl extends ComCallbackImpl implements ComInvalidateCallback {
	/**
	 ...
	 * @generated
	 */
	protected ComInvalidateCallbackImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModulePackage.Literals.COM_INVALIDATE_CALLBACK;
	}
	...
	public EList<SendOperation> getOperation() {
		if (operation == null) {
			operation = new EObjectContainmentEList<SendOperation>(SendOperation.class, this, ModulePackage.COM_INVALIDATE_CALLBACK__OPERATION);
		}
		return operation;
	}
		...
		if (filterResultVariable != null && ((EObject)filterResultVariable).eIsProxy()) {
			...
			if (filterResultVariable != oldFilterResultVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModulePackage.COM_INVALIDATE_CALLBACK__FILTER_RESULT_VARIABLE, oldFilterResultVariable, filterResultVariable));
			}
		}
	...
	public void setFilterResultVariable(LocalVariable newFilterResultVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.COM_INVALIDATE_CALLBACK__FILTER_RESULT_VARIABLE, oldFilterResultVariable, filterResultVariable));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModulePackage.COM_INVALIDATE_CALLBACK__OPERATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModulePackage.COM_INVALIDATE_CALLBACK__OPERATION:
				return getOperation();
			case ModulePackage.COM_INVALIDATE_CALLBACK__FILTER_RESULT_VARIABLE:
