 ...
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ComSendProxyOperationImpl#getReadValueVariable <em>Read Value Variable</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ComSendProxyOperationImpl#getAccessApi <em>Access Api</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ComSendProxyOperationImpl#getSignalIdVariable <em>Signal Id Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComSendProxyOperationImpl extends OperationImpl implements ComSendProxyOperation {
		...
		if (readValueVariable != null && ((EObject)readValueVariable).eIsProxy()) {
			...
			if (readValueVariable != oldReadValueVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModulePackage.COM_SEND_PROXY_OPERATION__READ_VALUE_VARIABLE, oldReadValueVariable, readValueVariable));
			}
		}
	...
	public void setReadValueVariable(Variable newReadValueVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.COM_SEND_PROXY_OPERATION__READ_VALUE_VARIABLE, oldReadValueVariable, readValueVariable));
	}
	...
	public Variable getSignalIdVariable() {
		if (signalIdVariable != null && ((EObject)signalIdVariable).eIsProxy()) {
			...
			if (signalIdVariable != oldSignalIdVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModulePackage.COM_SEND_PROXY_OPERATION__SIGNAL_ID_VARIABLE, oldSignalIdVariable, signalIdVariable));
			}
		}
	...
	public void setSignalIdVariable(Variable newSignalIdVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.COM_SEND_PROXY_OPERATION__SIGNAL_ID_VARIABLE, oldSignalIdVariable, signalIdVariable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModulePackage.COM_SEND_PROXY_OPERATION__READ_VALUE_VARIABLE:
			...
			case ModulePackage.COM_SEND_PROXY_OPERATION__SIGNAL_ID_VARIABLE:
