...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Com Receive Callback</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ComReceiveCallbackImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ComReceiveCallbackImpl#getDataVariable <em>Data Variable</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ComReceiveCallbackImpl#getAccessApi <em>Access Api</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ComReceiveCallbackImpl extends ComCallbackImpl implements ComReceiveCallback {
	/**
	 ...
	 * @generated
	 */
	protected ComReceiveCallbackImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModulePackage.Literals.COM_RECEIVE_CALLBACK;
	}
	...
	public EList<SendOperation> getOperation() {
		if (operation == null) {
			operation = new EObjectContainmentEList<SendOperation>(SendOperation.class, this, ModulePackage.COM_RECEIVE_CALLBACK__OPERATION);
		}
		return operation;
	}
	...
	public ComReceiveSignalApi getAccessApi() {
		if (accessApi != null && ((EObject)accessApi).eIsProxy()) {
			...
			if (accessApi != oldAccessApi) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModulePackage.COM_RECEIVE_CALLBACK__ACCESS_API, oldAccessApi, accessApi));
			}
		}
		return accessApi;
	}
	...
	public void setAccessApi(ComReceiveSignalApi newAccessApi) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.COM_RECEIVE_CALLBACK__ACCESS_API, oldAccessApi, accessApi));
	}
