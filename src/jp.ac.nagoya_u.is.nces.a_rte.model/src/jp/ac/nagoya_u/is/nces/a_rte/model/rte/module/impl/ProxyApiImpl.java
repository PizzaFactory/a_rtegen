 ...
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ProxyApiImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ProxyApiImpl#getIocReceiveSymbolName <em>Ioc Receive Symbol Name</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ProxyApiImpl#getSignalGroupSymbolName <em>Signal Group Symbol Name</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ProxyApiImpl#getBufferComProxySymbolName <em>Buffer Com Proxy Symbol Name</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ProxyApiImpl#getBufferComMetaComplexDataSymbolName <em>Buffer Com Meta Complex Data Symbol Name</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ProxyApiImpl#getProxyDataTypeName <em>Proxy Data Type Name</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.ProxyApiImpl#getIsGroup <em>Is Group</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ProxyApiImpl extends FunctionImpl implements ProxyApi {
	/**
	...
	protected EClass eStaticClass() {
		return ModulePackage.Literals.PROXY_API;
	}
	...
	public Partition getParent() {
		if (eContainerFeatureID() != ModulePackage.PROXY_API__PARENT) return null;
	...
	public NotificationChain basicSetParent(Partition newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, ModulePackage.PROXY_API__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(Partition newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != ModulePackage.PROXY_API__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, ModulePackage.PARTITION__PROXY_API, Partition.class, msgs);
			msgs = basicSetParent(newParent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.PROXY_API__PARENT, newParent, newParent));
	}
	...
	public void setIocReceiveSymbolName(String newIocReceiveSymbolName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.PROXY_API__IOC_RECEIVE_SYMBOL_NAME, oldIocReceiveSymbolName, iocReceiveSymbolName));
	}
	...
	public void setSignalGroupSymbolName(String newSignalGroupSymbolName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.PROXY_API__SIGNAL_GROUP_SYMBOL_NAME, oldSignalGroupSymbolName, signalGroupSymbolName));
	}
	...
	public void setBufferComProxySymbolName(String newBufferComProxySymbolName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.PROXY_API__BUFFER_COM_PROXY_SYMBOL_NAME, oldBufferComProxySymbolName, bufferComProxySymbolName));
	}
	...
	public void setBufferComMetaComplexDataSymbolName(String newBufferComMetaComplexDataSymbolName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.PROXY_API__BUFFER_COM_META_COMPLEX_DATA_SYMBOL_NAME, oldBufferComMetaComplexDataSymbolName, bufferComMetaComplexDataSymbolName));
	}
	...
	public void setProxyDataTypeName(String newProxyDataTypeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.PROXY_API__PROXY_DATA_TYPE_NAME, oldProxyDataTypeName, proxyDataTypeName));
	}
	...
	public void setIsGroup(Boolean newIsGroup) {
		...
		isGroup = newIsGroup;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.PROXY_API__IS_GROUP, oldIsGroup, isGroup));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModulePackage.PROXY_API__PARENT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ModulePackage.PROXY_API__PARENT:
				return eInternalContainer().eInverseRemove(this, ModulePackage.PARTITION__PROXY_API, Partition.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModulePackage.PROXY_API__PARENT:
				return getParent();
			case ModulePackage.PROXY_API__IOC_RECEIVE_SYMBOL_NAME:
				return getIocReceiveSymbolName();
			case ModulePackage.PROXY_API__SIGNAL_GROUP_SYMBOL_NAME:
				return getSignalGroupSymbolName();
			case ModulePackage.PROXY_API__BUFFER_COM_PROXY_SYMBOL_NAME:
				return getBufferComProxySymbolName();
			case ModulePackage.PROXY_API__BUFFER_COM_META_COMPLEX_DATA_SYMBOL_NAME:
				return getBufferComMetaComplexDataSymbolName();
			case ModulePackage.PROXY_API__PROXY_DATA_TYPE_NAME:
				return getProxyDataTypeName();
			case ModulePackage.PROXY_API__IS_GROUP:
				return getIsGroup();
		}
