 ...
 * <ul>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.FunctionGroupImpl#getMemoryMapping <em>Memory Mapping</em>}</li>
 *   <li>{@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.impl.FunctionGroupImpl#getFunction <em>Function</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class FunctionGroupImpl extends ModuleObjectImpl implements FunctionGroup {
	/**
	...
	protected EClass eStaticClass() {
		return ModulePackage.Literals.FUNCTION_GROUP;
	}
		...
		if (memoryMapping != null && ((EObject)memoryMapping).eIsProxy()) {
			...
			if (memoryMapping != oldMemoryMapping) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModulePackage.FUNCTION_GROUP__MEMORY_MAPPING, oldMemoryMapping, memoryMapping));
			}
		}
	...
	public void setMemoryMapping(MemoryMapping newMemoryMapping) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModulePackage.FUNCTION_GROUP__MEMORY_MAPPING, oldMemoryMapping, memoryMapping));
	}
	...
	public EList<Function> getFunction() {
		if (function == null) {
			function = new EObjectResolvingEList<Function>(Function.class, this, ModulePackage.FUNCTION_GROUP__FUNCTION);
		}
		return function;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModulePackage.FUNCTION_GROUP__MEMORY_MAPPING:
				if (resolve) return getMemoryMapping();
				return basicGetMemoryMapping();
			case ModulePackage.FUNCTION_GROUP__FUNCTION:
				return getFunction();
		}
