...
/**
 * This is the item provider adapter for a {@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.CsTfCalledRunnable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CsTfCalledRunnableItemProvider extends ModuleObjectItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CsTfCalledRunnableItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModulePackage.Literals.CS_TF_CALLED_RUNNABLE__START_OPERATION);
		}
	...
	/**
	 * This returns CsTfCalledRunnable.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getStyledText(Object object) {
		...
		if (label == null || label.length() == 0) {
			styledLabel.append(getString("_UI_CsTfCalledRunnable_type"), StyledString.Style.QUALIFIER_STYLER);  //$NON-NLS-1$
		} else {
			styledLabel.append(getString("_UI_CsTfCalledRunnable_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label); //$NON-NLS-1$ //$NON-NLS-2$
		}
		return styledLabel;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CsTfCalledRunnable.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModulePackage.Literals.CS_TF_CALLED_RUNNABLE__START_OPERATION,
