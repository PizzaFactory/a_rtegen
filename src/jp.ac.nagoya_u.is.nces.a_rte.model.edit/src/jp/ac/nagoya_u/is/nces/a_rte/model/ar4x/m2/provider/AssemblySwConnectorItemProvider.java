...
/**
 * This is the item provider adapter for a {@link jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.m2.AssemblySwConnector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssemblySwConnectorItemProvider extends SwConnectorItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AssemblySwConnectorItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(M2Package.Literals.ASSEMBLY_SW_CONNECTOR__PROVIDER_IREF);
			childrenFeatures.add(M2Package.Literals.ASSEMBLY_SW_CONNECTOR__REQUESTER_IREF);
		}
	...
	/**
	 * This returns AssemblySwConnector.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getStyledText(Object object) {
		...
		if (label == null || label.length() == 0) {
			styledLabel.append(getString("_UI_AssemblySwConnector_type"), StyledString.Style.QUALIFIER_STYLER);  //$NON-NLS-1$
		} else {
			styledLabel.append(getString("_UI_AssemblySwConnector_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label); //$NON-NLS-1$ //$NON-NLS-2$
		}
		return styledLabel;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AssemblySwConnector.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(M2Package.Literals.ASSEMBLY_SW_CONNECTOR__PROVIDER_IREF,
				 M2Factory.eINSTANCE.createPPortPrototypeInCompositionInstanceRef()));

		newChildDescriptors.add
			(createChildParameter
				(M2Package.Literals.ASSEMBLY_SW_CONNECTOR__REQUESTER_IREF,
				 M2Factory.eINSTANCE.createRPortPrototypeInCompositionInstanceRef()));
	}
