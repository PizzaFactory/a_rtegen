...
/**
 * This is the item provider adapter for a {@link jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.m2.DelegationSwConnector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DelegationSwConnectorItemProvider extends SwConnectorItemProvider {
	/**
	 ...
	 * @generated
	 */
	public DelegationSwConnectorItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(M2Package.Literals.DELEGATION_SW_CONNECTOR__INNER_PORT_IREF);
		}
	...
	/**
	 * This returns DelegationSwConnector.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getStyledText(Object object) {
		...
		if (label == null || label.length() == 0) {
			styledLabel.append(getString("_UI_DelegationSwConnector_type"), StyledString.Style.QUALIFIER_STYLER);  //$NON-NLS-1$
		} else {
			styledLabel.append(getString("_UI_DelegationSwConnector_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label); //$NON-NLS-1$ //$NON-NLS-2$
		}
		return styledLabel;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DelegationSwConnector.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(M2Package.Literals.DELEGATION_SW_CONNECTOR__INNER_PORT_IREF,
				 M2Factory.eINSTANCE.createPPortInCompositionInstanceRef()));

		newChildDescriptors.add
			(createChildParameter
				(M2Package.Literals.DELEGATION_SW_CONNECTOR__INNER_PORT_IREF,
				 M2Factory.eINSTANCE.createRPortInCompositionInstanceRef()));
	}
