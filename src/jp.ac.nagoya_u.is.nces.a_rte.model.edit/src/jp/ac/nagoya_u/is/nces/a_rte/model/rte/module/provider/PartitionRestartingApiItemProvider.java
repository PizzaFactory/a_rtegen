...
/**
 * This is the item provider adapter for a {@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.PartitionRestartingApi} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PartitionRestartingApiItemProvider extends RteLifecycleApiItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PartitionRestartingApiItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns PartitionRestartingApi.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PartitionRestartingApi")); //$NON-NLS-1$
	}
	...
	public Object getStyledText(Object object) {
		String label = ((PartitionRestartingApi)object).getRoleName();
    	StyledString styledLabel = new StyledString();
		if (label == null || label.length() == 0) {
			styledLabel.append(getString("_UI_PartitionRestartingApi_type"), StyledString.Style.QUALIFIER_STYLER);  //$NON-NLS-1$
		} else {
			styledLabel.append(getString("_UI_PartitionRestartingApi_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label); //$NON-NLS-1$ //$NON-NLS-2$
		}
		return styledLabel;
	}
