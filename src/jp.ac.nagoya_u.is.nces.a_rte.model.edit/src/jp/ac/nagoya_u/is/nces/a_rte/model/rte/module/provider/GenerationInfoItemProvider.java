...
/**
 * This is the item provider adapter for a {@link jp.ac.nagoya_u.is.nces.a_rte.model.rte.module.GenerationInfo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GenerationInfoItemProvider extends ModuleObjectItemProvider {
	/**
	 ...
	 * @generated
	 */
	public GenerationInfoItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns GenerationInfo.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getStyledText(Object object) {
		...
		if (label == null || label.length() == 0) {
			styledLabel.append(getString("_UI_GenerationInfo_type"), StyledString.Style.QUALIFIER_STYLER);  //$NON-NLS-1$
		} else {
			styledLabel.append(getString("_UI_GenerationInfo_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label); //$NON-NLS-1$ //$NON-NLS-2$
		}
		return styledLabel;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GenerationInfo.class)) {
