...
/**
 * This is the item provider adapter for a {@link jp.ac.nagoya_u.is.nces.a_rte.model.ar4x.m2.QueuedReceiverComSpec} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QueuedReceiverComSpecItemProvider extends ReceiverComSpecItemProvider {
	/**
	 ...
	 * @generated
	 */
	public QueuedReceiverComSpecItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns QueuedReceiverComSpec.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getStyledText(Object object) {
		...
		if (label == null || label.length() == 0) {
			styledLabel.append(getString("_UI_QueuedReceiverComSpec_type"), StyledString.Style.QUALIFIER_STYLER);  //$NON-NLS-1$
		} else {
			styledLabel.append(getString("_UI_QueuedReceiverComSpec_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label); //$NON-NLS-1$ //$NON-NLS-2$
		}
		return styledLabel;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(QueuedReceiverComSpec.class)) {
